  ...
  settings: [
    {
      ...
      site: {
        name: 'Maharaniz',
        description:
          'Maharaniz is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'Next Ecommerce, Next.js, Tailwind CSS, MongoDB',
        url: 'https://maharani-blush.vercel.app',
        logo: '/icons/logo.svg',
      ...
      availableCurrencies: [
        { name: 'India', code: 'INR', symbol: '₹', convertRate: 87.52 },
